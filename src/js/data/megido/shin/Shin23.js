...
const megido = [
    {
        ...
        skills: [
            ...
            },
            {
                ...
                text: '2ターンの間、自身が巨大化状態になり、最大HP/攻撃力/防御力を40%ずつ上昇させ、さらに自身以外の攻撃力を30%上昇させる。ただし2ターンの間、自身が封印状態になる	',
                levels: [
                    {
                        level: 1,
                        magnification: 0,
    ...
    },
    {
        ...
        skills: [
            ...
            },
            {
                name: '美巨人のランウェイ＋',
                type: SkillType.Mysteries,
                text: '2ターンの間、自身が巨大化状態になり、最大HP/攻撃力/防御力を40%ずつ上昇させ、ターン終了時に自身以外のHPを20%回復。ただし2ターンの間、自身が封印状態になる',
                levels: [
                    {
                        level: 1,
                        magnification: 0,

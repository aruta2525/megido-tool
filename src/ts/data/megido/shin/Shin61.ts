        ...
        levels: [
          {
            ...
            hit: 0,
            text:
              '	2ターンの間、敵横一列を炎上の地形にし、地形効果で1.25倍の継続ダメージを与える。さらに敵の攻撃力を25%低下させる【使用するごとにスキルLvが上昇する】'
          },
          {
            level: 2,
            magnification: 0,
            hit: 0,
            text:
              '2ターンの間、敵横一列を炎上の地形にし、地形効果で1.5倍の継続ダメージを与える。さらに敵の攻撃力を30%低下させる【使用するごとにスキルLvが上昇する】'
          },
          {
            level: 3,
            magnification: 0,

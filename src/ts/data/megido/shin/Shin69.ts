  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        type: SkillType.AwakeningSkill,
        text:
          '2ターンの間、自身のダメージを20%軽減し、1ターンの間、自身をアラプリマ状態にする。さらに自身が種族に【精霊】を持つオーブを装備時、自身に彩色のオーラを2個付与する	',
        levels: [
          {
            level: 1,
            magnification: 0,
      ...
      },
      {
        ...
        levels: [
          ...
          },
          {
            ...
            hit: 1,
            text:
              '自身のオーラを2個消費し、敵横一列に攻撃力2.25倍のダメージ。2ターンの間、1.75倍ダメージの浸食地形。積まれているフォトン1つを70%の確率でペインフォトンに転換する	'
          }
        ],
        increment: 0.05
      }

        ...
        levels: [
          {
            ...
            hit: 0,
            text:
              '2ターンの間、敵横一列を60%の確率で暗闇状態にし、90%の確率で攻撃力を10%低下させる。チェイン中、味方単体にチェイン。チェイン数に応じて効果が変化'
          },
          {
            level: 2,
            label: 'Ch1',
            ...
            hit: 0,
            text:
              '2ターンの間、敵横一列を70%の確率で暗闇状態にし、90%の確率で攻撃力を20%低下させる。チェイン中、味方単体にチェイン。チェイン数に応じて効果が変化'
          },
          {
            level: 3,
            label: 'Ch2',
        ...
        levels: [
          {
            ...
            hit: 1,
            text:
              '敵横一列に攻撃力2.25倍のダメージ。2ターンの間対象がフォトンを使用する度、浸食の地形効果で1.75倍のダメージ。味方単体にチェイン。チェイン数に応じてターン数変化'
          },
          {
            level: 1,
            label: 'Ch1',
            ...
            hit: 1,
            text:
              '敵横一列に攻撃力2.25倍のダメージ。3ターンの間対象がフォトンを使用する度、浸食の地形効果で1.75倍のダメージ。味方単体にチェイン。チェイン数に応じてターン数変化'
          },
          {
            level: 1,
            label: 'Ch2',
